...
{
    DynDenseVector<Real> a({ -2., 5, 1. });
    DynDenseVector<Real> b({ 3, 1, 2 });
    auto v = cross_product(a, b);
    EXPECT_EQ(v(0), 9.);
    EXPECT_EQ(v(1), 7.);
    EXPECT_EQ(v(2), -17.);
