...
l2_diff_eval(Int dim, PetscReal time, const PetscReal x[], Int nc, PetscScalar u[], void * ctx)
{
...
void
L2Diff::evaluate(Int dim, PetscReal time, const PetscReal x[], Int nc, PetscScalar u[])
{
    _F_;
