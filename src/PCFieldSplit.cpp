...
IndexSet
PCFieldSplit::get_is(const String & split_name) const
{
    CALL_STACK_MSG();
    IndexSet is;
...
void
PCFieldSplit::set_fields(const String & split_name,
...
void
PCFieldSplit::set_is(const String & split_name, const IndexSet & is)
{
    CALL_STACK_MSG();
